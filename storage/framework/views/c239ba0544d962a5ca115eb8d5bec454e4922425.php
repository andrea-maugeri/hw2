<html>
  <head>
    ...
    <script src="<?php echo e(asset('scripts/home.js')); ?>" defer="true"></script>
    <script type="text/javascript">
        const CSRF_TOKEN = '<?php echo e(csrf_token()); ?>'; //per poter fare funzionare l header del csrf quando faccio le richieste post da js..la funzione csrf_token() funziona solo su php ..piuttosto che aggiungere dinamicamente un campo hidden con csrf con create element
    </script>
</head>
  <body>
    <header>
      <nav>
        <div id="links">
            ...
            <a href="<?php echo e(route('favorite')); ?>">Preferiti</a>
            <a href="<?php echo e(route('search')); ?>">Podcast</a>
      ...
      <h1>
        <strong>Benvenuto <?php echo e($user); ?> ,</br> naviga tra tanti articoli relativi </br> al mondo delle criptovalute </strong></br>
...
</html><?php /**PATH C:\Users\Andrea Maugeri\example-app\resources\views/home.blade.php ENDPATH**/ ?>